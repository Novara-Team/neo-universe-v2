              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-4 bg-gradient-to-b from-slate-50 via-white to-slate-50">
                ...
                {messages.map((msg, index) => {
                  ...
                  return (
                    ...
                    >
                      {!isUser && showAvatar && (
                        <div className="w-10 h-10 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg bg-gradient-to-br from-slate-700 to-slate-900 border border-slate-600">
