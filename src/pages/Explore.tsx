            ...
            {loading ? (
              <div className="text-center py-12 animate-in fade-in duration-500">
                <div className="relative inline-flex items-center justify-center">
                  <div className="absolute animate-ping rounded-full h-16 w-16 bg-cyan-500/30"></div>
                  <div className="relative animate-spin rounded-full h-12 w-12 border-4 border-cyan-500/20 border-t-cyan-500 shadow-lg shadow-cyan-500/20"></div>
                </div>
                <p className="text-slate-400 mt-4 font-medium">Loading tools...</p>
